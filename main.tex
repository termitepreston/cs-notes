...
Jakarata EE also previously known as Java Enterprise Edition is a set of \emph{Specification} that greatly extend the 
Java platform for enterprise use, especially with concert to web applications and distributed applications.
